...
app.factory('MenuDgService', ['DGConstant', '$hyUtil', '$appConfig', '$rootScope',
    function (DGConstant, $hyUtil, $appConfig, $rootScope) {
        var moreMenu = {
            menuOrder: 0,  //菜单排序号
            menuName: "更多",   //菜单的名称
        ...
        var allMenuList = DGConstant.MENU_LIST.sort(function (a, b) {
            return a.menuOrder - b.menuOrder;
        });
        var menuList = DGConstant.MENU_LIST.filter(function (menu) {
            return !menu.notShow;
        }).sort(function (a, b) {
            return a.menuOrder - b.menuOrder;
        });
        var groupList = DGConstant.GROUP_LIST;
        return {
            /**
             * 获取菜单列表
