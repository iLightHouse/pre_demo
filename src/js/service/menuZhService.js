...
app.factory('MenuZhService', ['ZhConstant', '$hyUtil', '$appConfig', '$rootScope',
    function (ZhConstant, $hyUtil, $appConfig, $rootScope) {
        var moreMenu = {
            menuOrder: 0,  //菜单排序号
            menuName: "更多",   //菜单的名称
        ...
        var allMenuList = ZhConstant.MENU_LIST.sort(function (a, b) {
            return a.menuOrder - b.menuOrder;
        });
        var menuList = ZhConstant.MENU_LIST.filter(function (menu) {
            return !menu.notShow;
        }).sort(function (a, b) {
            return a.menuOrder - b.menuOrder;
        });
        var groupList = ZhConstant.GROUP_LIST;
        return {
            /**
             * 获取菜单列表
